      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="{{ url('website/images/featured.jpg')}}" alt="">
            <a href="property-details.html"><img src="{{ url('website/images/featured-icon.png')}}" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
        ...
        <div class="col-lg-3">
          <div class="info-table">
            <ul>
              <li>
                <img src="{{ url('website/images/info-icon-01.png')}}" alt="" style="max-width: 52px;">
                <h4>250 m2<br><span>Total Flat Space</span></h4>
              </li>
              <li>
                <img src="{{ url('website/images/info-icon-02.png')}}" alt="" style="max-width: 52px;">
                <h4>Contract<br><span>Contract Ready</span></h4>
              </li>
              <li>
                <img src="{{ url('website/images/info-icon-03.png')}}" alt="" style="max-width: 52px;">
                <h4>Payment<br><span>Payment Process</span></h4>
              </li>
              <li>
                <img src="{{ url('website/images/info-icon-04.png')}}" alt="" style="max-width: 52px;">
      ...
      <div class="row">
        <div class="col-lg-10 offset-lg-1">
          <div class="video-frame">
            <img src="{{ url('website/images/video-frame.jpg')}}" alt="">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="{{ url('website/images/deal-01.jpg')}}" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="{{ url('website/images/deal-02.jpg')}}" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src="{{ url('website/images/deal-03.jpg')}}" alt="">
                    </div>
                    <div class="col-lg-3">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="admin/img/assets/properties/<?php echo $value->image_url;?>" alt=""></a>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="item phone">
                <img src="{{ url('website/images/phone-icon.png')}}" alt="" style="max-width: 52px;">
                <h6>010-020-0340<br><span>Phone Number</span></h6>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="item email">
                <img src="{{ url('website/images/email-icon.png')}}" alt="" style="max-width: 52px;">
