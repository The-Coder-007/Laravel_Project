              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>
                            <h6 data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Edit" class="d-inline-block mb-0"><a href="{{ url('/edit_propertyDetails/' . $val->id) }}"><i style="vertical-align:middle; margin-right:5px;" class="fa fa-edit col_3"></i></a></h6>
                            <h6 data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Delete" class="d-inline-block mb-0"><a href="{{ url('/delete_propertyDetails/' . $val->id) }}"><i style="vertical-align:middle; margin-right:5px;" class="fa fa-trash col_3"></i></a></h6>
                                </td>
